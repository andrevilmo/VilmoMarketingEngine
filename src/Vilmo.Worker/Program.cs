...
{
    Kinds = [WorkKinds.SaleImport, WorkKinds.PublishListing, WorkKinds.ListingRefresh, WorkKinds.ListingCancel, WorkKinds.ListingImport, WorkKinds.StockPublish, WorkKinds.UploadInvoice]
});
