...
| Advertisements | `#/anuncios` form: **Um produto** or **Conjunto / kit**; common marketplace fields; per-channel extras; item rows (SKU + qty in the set) | Publish for the **selected company**. Kit: N SKUs, each qty ≥ 1. Paid sale explodes kit BOM into stock. Vendor: own ads. |
